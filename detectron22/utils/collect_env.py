...
def collect_env_info():
    ...
    try:
        import detectron22  # noqa

        data.append(
            ("detectron2", detectron22.__version__ + " @" + os.path.dirname(detectron22.__file__))
        )
    except ImportError:
...
if __name__ == "__main__":
    try:
        from detectron22.utils.collect_env import collect_env_info as f
