...
from detectron22.data import DatasetCatalog, MetadataCatalog
from detectron22.structures import BoxMode
from detectron22.utils.file_io import PathManager
from detectron22.data.datasets.lvis_v1_categories import LVIS_CATEGORIES as LVIS_V1_CATEGORIES
...
_CUSTOM_SPLITS_LVIS = {
    "lvis_v1_minival": ("coco2017/", "coco2017/lvis_v1_minival.json"),
}
...
for key, (image_root, json_file) in _CUSTOM_SPLITS_LVIS.items():
    register_lvis_instances(
        ...
        os.path.join("/home/data/Public_Data", json_file) if "://" not in json_file else json_file,
        os.path.join("/home/data/Public_Data", image_root),
    )
