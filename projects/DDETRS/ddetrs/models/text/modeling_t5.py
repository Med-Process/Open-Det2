...
from .feedforward import Feedforard_Network
...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def __init__(self, config: T5Config):
        ...
        self.shared = lora.Embedding(config.vocab_size, config.d_model, r=16)
        ...
        self.lm_head = lora.Linear(config.d_model, config.vocab_size, r=16)

        self.feed_hide_state = Feedforard_Network()
    ...
    def forward(
        ...
        # hidden_states2 = self.feed_hide_state(hidden_states)
